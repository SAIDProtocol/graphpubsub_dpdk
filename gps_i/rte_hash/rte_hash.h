...
#ifndef _RTE_HASH_X_H_
#define _RTE_HASH_X_H_
 ...
 */
/* int32_t
 * rte_hash_add_key_with_hash_data_x(const struct rte_hash_x *h, const void *key,
 ...
 */
int32_t
rte_hash_add_key_with_hash_x(const struct rte_hash_x *h, const void *key, hash_sig_t sig);
